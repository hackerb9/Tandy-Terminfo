...
builtin TELCOM software) is missing too many features
* Scroll reverse
* Insert mode
...
_May_ be possible depending on the program being run. Many of the
possible problems I can foresee are relatively minor or unlikely.
